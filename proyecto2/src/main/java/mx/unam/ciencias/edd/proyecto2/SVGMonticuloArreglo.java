...
/**
 * Clase para dibujar un MonticuloArreglo.
 */
public class SVGMonticuloArreglo{

  /** Contiene los elementos que vamos a dibujar*/
   ...
   * @param enteros lista de elementos que vamos a ordenar con heapSort y
   * convertir en un ArbolBinarioCompleto.
   */
  public SVGMonticuloArreglo(Lista<Integer> enteros){
  ...
  /**
   * @param x posición x donde irá el texto.
   * @param elemento que va dentro de la casilla del arreglo.
  ...
  /**
   * @return el código SVG que dibuja todo el MonticuloArreglo.
   */
